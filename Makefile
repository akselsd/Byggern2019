...
SOURCE_FILES := main.c uart.c tests/sram_test.c tests/usb_multifunction_board_test.c usb_multifunction_card/joystick.c usb_multifunction_card/usb_multifunction_card_io.c usb_multifunction_card/slider.c usb_multifunction_card/buttons.c usb_multifunction_card/oled.c usb_multifunction_card/menu.c can/can_driver.c
