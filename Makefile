...
SOURCE_FILES := main.c uart.c sram_test.c tests/joystick_test.c tests/slider_tests.c usb_multifunction_card/joystick.c usb_multifunction_card/usb_multifunction_card_io.c usb_multifunction_card/slider.c tests/button_test.c usb_multifunction_card/buttons.c usb_multifunction_card/oled.c usb_multifunction_card/menu.c
